...
1. Из скачанного в разделе Релиз файла ___1Cv8_TestData.dt___ развернуть две базы:
    -  тест-менеджер
    -  тест-клиент
2. Распаковать из релиза zip-файл ___Test.zip___.
...
6. Выполнить следующие настройки окружения для запуска теста:
    ...
    *  Добавить библиотеку повторного кода ( __Библиотеки__->__Добавить__)
        ...
        _Путь_\\__Тесты\ВКМ__, где _Путь_ это путь до папки __Тесты__ из распакованного архива ___Test.zip___. <br>Например _D:\Нетология\ИтоговыеРаботы\Диплом_
